"""
Cluster-Adapted Spark Demo (for Dockerized Workflow)

- Run this script inside the Jupyter container (see SPARK_README.md for instructions).
- Uses Spark master at 'spark://spark-master:7077'.
- All file paths are relative to the container's /home/jovyan/work directory.
- Place this script in the notebooks/ directory (mounted as /home/jovyan/work).
"""
...
spark = (
    ...
    .appName("Cluster Spark Full Demo")
...
data_with_missing = [Row(name="Eve", age=None, income=50000, label=1), Row(name="Frank", age=38, income=None, label=0)]
