#!/usr/bin/env python3
"""
Working Local Mode Demo - No Python Version Issues
"""

print("🔧 Testing Spark Local Mode (No Version Conflicts)...")
print("=" * 60)

try:
    from pyspark_cluster.connection import get_local_spark_session
    
    print("📡 Connecting to Spark in local mode...")
    spark = get_local_spark_session("LocalModeDemo")
